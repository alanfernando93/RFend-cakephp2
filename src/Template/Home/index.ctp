<section id="featured">
    ...
    <div id="main-slider" class="flexslider">
        <ul class="slides">
            <li>
                <img src="ViewCoreBusiness/img/slides/1.jpg" alt="" />
            ...
            <li>
                <img src="ViewCoreBusiness/img/slides/2.jpg" alt="" />
                <div class="flex-caption">
                    <div class="item_introtext"> 
            ...
            <li>
                <img src="ViewCoreBusiness/img/slides/3.jpg" alt="" />
                <div class="flex-caption">
                    <div class="item_introtext"> 
                        ...
                        <ul id="thumbs" class="portfolio"> 
                            <li class="col-lg-3 design" data-id="id-0" data-type="web">
                                <div class="item-thumbs">					 
                                    <img src="ViewCoreBusiness/img/works/1.jpg" alt=""><br>
                                    <p>Blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et.</p>
                                </div>
                            </li> 
                            <!-- Item Project and Filter Name -->
                            <li class="item-thumbs col-lg-3 design" data-id="id-1" data-type="icon">
                                <img src="ViewCoreBusiness/img/works/2.jpg" alt=""><br>
                                <p>Blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et.</p>
                            </li> 
                            <li class="item-thumbs col-lg-3 photography" data-id="id-2" data-type="illustrator">
                                <img src="ViewCoreBusiness/img/works/3.jpg" alt=""><br>
                                <p>Blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et.</p>
                            </li>

                            <li class="item-thumbs col-lg-3 photography" data-id="id-2" data-type="illustrator">					
                                <img src="ViewCoreBusiness/img/works/4.jpg" alt=""><br>
                                <p>Blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et.</p>
                            </li>
                            <!-- End Item Project -->
                        </ul>
